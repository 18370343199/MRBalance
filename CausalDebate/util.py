...
@backoff.on_exception(backoff.expo, (TypeError, KeyError, JSONDecodeError, ReadTimeout, ConnectionError, ConnectTimeout,Exception), max_tries=20)
def generate_answer(answer_context, model="gpt-3.5-turbo-1106", temperature=0):
    ...
    response = client.chat.completions.create(
        model=model,
        messages=answer_context, # 格式需要为[..., {'role': 'user', 'content': '询问内容'}]
        temperature = 0.2,
        # top_p=0.95,
        max_tokens = 1024,
        n=1
